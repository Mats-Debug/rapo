...
export default function Footer() {
  return (
    <footer className="h-fit flex flex-col py-5 border-t bg-blue-800  text-white">

      <section className="flex flex-col px-20 items-center gap-5">
        <nav className="flex flex-row gap-10">
      
          <Link href={""} className="link link-hover">Home</Link>
          <Link href={""} className="link link-hover">Programs</Link>
          <Link href={""} className="link link-hover">Gallery</Link>
          <Link href={""} className="link link-hover">Who We Are</Link>
